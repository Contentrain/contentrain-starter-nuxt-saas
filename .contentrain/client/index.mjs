...
import _changelogEntryDeployReadySeoAndMetadataEn from './data/changelog-entry--deploy-ready-seo-and-metadata.en.mjs'
import _changelogEntryMultiSurfaceLaunchCopyEn from './data/changelog-entry--multi-surface-launch-copy.en.mjs'
import _faqItemEn from './data/faq-item.en.mjs'
...
import _testimonialEn from './data/testimonial.en.mjs'
...
const _doc_changelog_entry = new Map([
  ['en', [_changelogEntryDeployReadySeoAndMetadataEn, _changelogEntryMultiSurfaceLaunchCopyEn]],
])
